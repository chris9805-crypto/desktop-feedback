...
const ROWS: StockRow[] = [
  ...
  // --- cybersecurity
  { s: "PANW", name: "Palo Alto Networks", sector: "informationTechnology", industry: "Cybersecurity", region: "us", price: 368.2, mcap: 242, vol: 0.334, beta: 1.08,
    f: [8.0, 0.20, 0.58, 0.742, 0.092, 0.301, 0.382, 0.142, 0.598, -1.2, 42, 0.86, 0.018, 0, 0, 0],
    v: [47.2, 54.8, 88.4, 14.6, 21.8, 0.022],
    about: "Firewalls and security software, mid-shift from hardware appliances to subscriptions. Reported earnings are flattered by a one-off tax item." },
  { s: "CRWD", name: "CrowdStrike", sector: "informationTechnology", industry: "Cybersecurity", region: "us", price: 342.6, mcap: 84, vol: 0.446, beta: 1.14,
    f: [3.9, 0.36, 1.18, 0.752, 0.048, 0.078, 0.312, 0.058, 0.108, -2.5, 26, 1.74, 0.034, 0, 0, 0],
    v: [96.4, 78.2, 182.0, 21.6, 26.8, 0.015],
    about: "Endpoint security delivered from the cloud. Growing fast and priced for it; a 2024 outage showed how concentrated the operational risk is." },
  { s: "FTNT", name: "Fortinet", sector: "informationTechnology", industry: "Cybersecurity", region: "us", price: 94.8, mcap: 73, vol: 0.362, beta: 1.04,
    f: [5.7, 0.22, 0.34, 0.792, 0.312, 0.284, 0.334, 0.418, 1.12, -1.8, 58, 1.42, -0.021, 0, 0, 0],
    v: [38.6, 35.4, 30.8, 11.4, 37.2, 0.028],
    about: "Network security with unusually high margins for the sector, because it designs its own silicon rather than buying it." },
  { s: "ZS", name: "Zscaler", sector: "informationTechnology", industry: "Cybersecurity", region: "us", price: 198.4, mcap: 31, vol: 0.472, beta: 1.12,
    f: [2.3, 0.38, 0.48, 0.772, -0.018, 0.012, 0.242, 0.021, 0.028, -1.5, 8, 1.28, 0.041, 0, 0, 0],
    v: [0, 84.6, 0, 13.4, 21.6, 0.011],
    about: "Routes corporate traffic through its own cloud instead of a corporate network. Still barely profitable on reported earnings." },

  // --- AI infrastructure
  { s: "ANET", name: "Arista Networks", sector: "informationTechnology", industry: "Networking", region: "us", price: 108.4, mcap: 136, vol: 0.382, beta: 1.16,
    f: [7.0, 0.30, 0.44, 0.642, 0.418, 0.402, 0.384, 0.318, 0.312, -1.6, 90, 4.18, 0.004, 0, 0, 0],
    v: [46.8, 41.6, 35.4, 17.8, 12.1, 0.023],
    about: "High-speed switching for data centres. A handful of hyperscale customers are most of the revenue." },
  { s: "VRT", name: "Vertiv Holdings", sector: "industrials", industry: "Electrical Equipment", region: "us", price: 112.6, mcap: 42, vol: 0.468, beta: 1.42,
    f: [8.0, 0.20, 0.88, 0.362, 0.168, 0.112, 0.128, 0.218, 0.452, 0.9, 12, 1.21, 0.004, 0.0012, 0.02, 1],
    v: [62.4, 38.1, 41.8, 5.4, 18.6, 0.016],
    about: "Power and cooling for data centres. Sold as an AI story; underneath it is a cyclical industrial with real backlog." },
  { s: "AMAT", name: "Applied Materials", sector: "informationTechnology", industry: "Semiconductor Equipment", region: "us", price: 186.4, mcap: 152, vol: 0.348, beta: 1.44,
    f: [27.2, 0.06, 0.12, 0.474, 0.292, 0.258, 0.248, 0.328, 0.421, -0.3, 54, 2.48, -0.028, 0.0092, 0.2, 7],
    v: [21.4, 18.8, 16.2, 5.6, 8.4, 0.046],
    about: "Makes the machines that make chips. Deeply cyclical, and exposed to export controls on China." },
  { s: "MU", name: "Micron Technology", sector: "informationTechnology", industry: "Semiconductors", region: "us", price: 98.4, mcap: 110, vol: 0.462, beta: 1.52,
    f: [25.1, 0.02, 0.28, 0.221, 0.132, 0.118, 0.048, 0.062, 0.071, 0.6, 9, 2.62, 0.008, 0.0046, 0.12, 3],
    v: [24.2, 11.4, 20.8, 4.4, 2.4, 0.012],
    about: "Memory chips — the most cyclical corner of semiconductors. Prices swing violently between shortage and glut." },
  { s: "NOW", name: "ServiceNow", sector: "informationTechnology", industry: "Software - Application", region: "us", price: 942.6, mcap: 194, vol: 0.312, beta: 1.06,
    f: [11.0, 0.24, 0.52, 0.792, 0.132, 0.128, 0.312, 0.142, 0.168, -1.0, 62, 1.12, 0.005, 0, 0, 0],
    v: [138.4, 58.2, 118.0, 17.6, 20.8, 0.019],
    about: "Workflow software for large enterprises. Very sticky, and priced as though it will stay that way." },

  // --- energy transition
  { s: "FSLR", name: "First Solar", sector: "informationTechnology", industry: "Solar", region: "us", price: 184.2, mcap: 20, vol: 0.522, beta: 1.38,
    f: [4.2, 0.28, 1.48, 0.442, 0.338, 0.302, -0.048, 0.152, 0.182, -0.5, 38, 2.12, 0.003, 0, 0, 0],
    v: [14.2, 11.4, 11.1, 4.6, 2.4, -0.012],
    about: "The one large US solar manufacturer, using a different panel technology from the Chinese incumbents. Policy support is a large part of the case." },
  { s: "ENPH", name: "Enphase Energy", sector: "informationTechnology", industry: "Solar", region: "us", price: 62.4, mcap: 8.2, vol: 0.628, beta: 1.64,
    f: [1.3, -0.24, -0.58, 0.462, 0.058, 0.082, 0.182, 0.048, 0.118, -0.8, 14, 3.42, 0.011, 0, 0, 0],
    v: [62.8, 28.4, 54.2, 5.2, 6.8, 0.032],
    about: "Solar microinverters for homes. Demand collapsed when interest rates rose and subsidies changed — a reminder that a theme is not a moat." },
