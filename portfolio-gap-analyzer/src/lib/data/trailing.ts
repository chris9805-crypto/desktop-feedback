...
export const TRAILING: Record<string, TrailingReturns> = {
  ...
  // --- thematic names
  PANW: T(0.028, 0.184), CRWD: T(0.064, 0.312), FTNT: T(0.092, 0.428), ZS: T(-0.018, 0.088),
  ANET: T(0.058, 0.341), VRT: T(0.124, 0.682), AMAT: T(-0.024, 0.068), MU: T(-0.041, 0.112),
  NOW: T(0.034, 0.218), FSLR: T(-0.082, -0.284), ENPH: T(-0.118, -0.512),
  SMH: T(0.086, 0.418), CIBR: T(0.041, 0.242), ICLN: T(-0.062, -0.184), DGRO: T(0.024, 0.138),
